  ...
  return (
    ...
    <div className="App">
      <svg className={`num-${tableau[0]}`} width="74" height="74" stroke-width="1" viewBox="0 0 74 74" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <path d="M73 1H1V73H73V1Z" stroke="red" stroke-width="1" stroke-miterlimit="10"/>
      ...
      <svg className={`num-${tableau[1]}`} width="74" height="74" viewBox="0 0 74 74" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <path d="M1 1H19H73V73H1V1Z" stroke="red" stroke-width="1" stroke-miterlimit="10"/>
        <path d="M28 73V37" stroke="red" stroke-width="1" stroke-miterlimit="10"/>
        <path d="M37 37V1" stroke="red" stroke-width="1" stroke-miterlimit="10"/>
        <path d="M46 73V37" stroke="red" stroke-width="1" stroke-miterlimit="10"/>
        </g>
        <defs>
      ...
      <svg className={`num-${tableau[2]}`} width="74" height="74" viewBox="0 0 74 74" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <path d="M28 73V37" stroke="red" stroke-width="1" stroke-miterlimit="10"/>
        <path d="M46 37V1" stroke="red" stroke-width="1" stroke-miterlimit="10"/>
        <path d="M73 1H1V73H73V1Z" stroke="red" stroke-width="1" stroke-miterlimit="10"/>
        </g>
        <defs>
      ...
      <svg className={`num-${tableau[3]}`} width="74" height="74" viewBox="0 0 74 74" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <path d="M1 1H73V28V73H1V28V1Z" stroke="red" stroke-width="1" stroke-miterlimit="10"/>
        <path d="M73 28H1" stroke="red" stroke-width="1" stroke-miterlimit="10"/>
        </g>
        <defs>
      ...
      <svg className={`num-${tableau[4]}`} width="74" height="74" viewBox="0 0 74 74" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <path d="M1 1H73V37V73H1V1Z" stroke="red" stroke-width="1" stroke-miterlimit="10"/>
        <path d="M37 37H73" stroke="red" stroke-width="1" stroke-miterlimit="10"/>
        </g>
        <defs>
